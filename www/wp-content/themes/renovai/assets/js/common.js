(function ($) {
	...
	$(document).ready(function(){
		...
		var $featuredLogosCarousel = $('.featured-logos-carousel');
		var $badgesCarousel = $('.badges-carousel');
		...
		if($badgesCarousel.exists()){
			$badgesCarousel.slick({
				arrows: false,
				slidesToShow: 5,
				slidesToScroll: 1,
				infinite: true,
				centerMode: true,
				responsive: [
					{breakpoint: 992, settings: {slidesToShow: 4, centerMode: false}},
		...
		if($featuredLogosCarousel.exists()){
			$featuredLogosCarousel.slick({
				arrows: false,
				slidesToShow: 6,
				slidesToScroll: 2,
				infinite: true,
				...
				responsive: [
					...
					{breakpoint: 376, settings: {slidesToShow: 1, slidesToScroll: 1, variableWidth: false, centerMode: true}}
				]
			});
		}
