...
?>
<div class="col-12 col-lg-6 text-lg-left -mt-lg-10 order-2">
	...
	<?php else:?>
		...
		<?php else:?>
			<img class="img-fluid d-md-none" src="<?=$item['desktop_image'];?>" alt="<?=$item['title'];?>" title="<?=$item['title'];?>">
		<?php endif;?>
	<?php endif;?>
	<img class="img-fluid img-static d-none d-md-inline-block" src="<?=$item['desktop_image'];?>" alt="<?=$item['title'];?>" title="<?=$item['title'];?>">
</div>
<div class="col-12 col-lg-5 offset-lg-1 -mt-lg-10 order-3 -pt-4 -pt-lg-0 item-content">
